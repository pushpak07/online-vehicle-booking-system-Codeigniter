 ...
 * 
 * @copyright   Copyright (c) 2017 Conquerors Technologies Pvt Ltd
 * @author      John Peter <johnpeter@conquerorstech.net>
 * @author_url  http://www.conquerorstech.net
 */
class Stripe {
	/**
	 ...
	 * Create customer 
	 * 
	 * @param  string        The email id of customer
	 * @param  string        current token
	 *
	 * @return object        returns the cutomer details
	 */
