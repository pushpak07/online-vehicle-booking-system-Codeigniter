            ...
            <table width="100%" border="0">
               <tr>
                  <td>
                     ...
                     <?php echo $info['name'];?>,  <?php echo $this->lang->line('mobile');?>: 
                     <?php echo $info['contact_no'];?>,  <?php echo $this->lang->line('email');?>:
                     <?php echo $info['email'];?> , <?php echo $this->lang->line('booking_reference_no');?>:
