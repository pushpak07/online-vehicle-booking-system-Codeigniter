    ...
    <div class="main-hed">
         ...
         <div class="module">
            ...
            <?php 
               ...
               echo form_open(site_url()."bookings/add_booking",$attributes);?>
               ...
               <div class="col-md-6">
                  ...
                  <div class="form-group">                    
                     <label><?php echo $this->lang->line('pick_date');?><?php echo required_symbol();?></label>    
                  ...
                  <div class="form-group">
                     <label> <?php echo $this->lang->line('pick_time');?><?php echo required_symbol();?></label>
