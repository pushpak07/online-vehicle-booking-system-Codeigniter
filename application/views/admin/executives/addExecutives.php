            ...
            <div class="module-body">
               <?php 
                  $attributes = array('name' => 'add_executives_form', 'id' => 'add_executives_form');
                   echo form_open("executives/add_executive",$attributes) ?>
               <div class="col-md-6">
               ...
               <button type="submit" name="add_executive" value="add_executive" class="pull-right"><?php echo $this->lang->line('save');?></button>
