      ...
      <?php echo $this->session->flashdata('message');?>
         ...
         <div class="row bmc-row">
          ...
          <div class="col-lg-3 col-md-3 col-sm-12">
            ...
            <div class="form-group filerSear clearfix"> 
              ...
              <select name="multioperation" id="multioperation" onchange="javascript:multioperationfunction(this.value, '<?php echo site_url().'vehicle_features/delete_record';?>', '<?php echo site_url().'vehicle_features/statustoggle';?>')">
         ...
         <!--Multi Operation-->
          ...
          <div class="col-lg-1 col-md-1 col-sm-12">
              <a class="btn btn-primary add-btn" href="<?php echo site_url();?>vehicle_features/addedit">
