   ...
   <div class="content">
       ...
       <div class="col-lg-3 col-md-3 col-sm-12">
          <!--Multi Operation-->
            <div class="form-group filerSear clearfix"> 
               ...
               <select name="multioperation" id="multioperation" onchange="javascript:multioperationfunction(this.value, '<?php echo site_url().'settings/delete_testimonial';?>', '<?php echo site_url().'settings/tetimonial_statustoggle';?>')">
      ...
      <!--Multi Operation-->
       ...
       <div class="col-lg-1 col-md-1 col-sm-12">
         <a class="btn btn-primary add-btn" href="<?php echo site_url();?>settings/addedit_testimonial">
