                        ...
                        <td>
                           <div class="btn-group">
                              ...
                              <ul class="dropdown-menu menu-drop" role="menu" aria-labelledby="dLabel">
                                 ...
                                 <li>
                                    <a href="<?php echo site_url();?>settings/bookings/confirm/<?php echo $row->id;?>/today"><?php echo $this->lang->line('confirm');?></a>
                                 </li>
                                 <?php } ?>
                                 <?php if($row->is_conformed=="pending" || $row->is_conformed=="confirm") { ?>
                                 <li>
                                    <a href="<?php echo site_url();?>settings/bookings/cancel/<?php echo $row->id;?>/today"><?php echo $this->lang->line('cancel');?></a>
                                 </li>
                                 <?php } ?>

                                 <li>
                                    <a onclick="return confirm('Are you sure to delete?');" href="<?php echo site_url();?>settings/bookings/delete/<?php echo $row->id;?>/today"><?php echo $this->lang->line('delete');?></a>
                                 </li>
