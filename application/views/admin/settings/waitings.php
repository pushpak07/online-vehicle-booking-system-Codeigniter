      ...
      <?php echo $this->session->flashdata('message');?>
         ...
         <div class="row bmc-row">
          ...
          <div class="col-lg-3 col-md-3 col-sm-12">
            ...
            <div class="form-group filerSear clearfix"> 
               ...
               <select name="multioperation" id="multioperation" onchange="javascript:multioperationfunction(this.value, '<?php echo site_url().'settings/delete_waiting';?>', '<?php echo site_url().'settings/waiting_statustoggle';?>')">
         ...
         <!--Multi Operation-->
          ...
          <div class="col-lg-1 col-md-1 col-sm-12">
            <a class="btn btn-primary add-btn" href="<?php echo site_url();?>settings/addedit_waiting">
            ...
            <table id="example" class="display responsive nowrap" width="100%" cellspacing="0">
                  ...
                  <thead>
                     <tr>
                        ...
                        <th><?php echo $this->lang->line('cost')." (".$this->config->item('site_settings')->currency_symbol.")";?></th>
